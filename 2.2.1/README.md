...
GDAL2:2.2.1 Docker images.

```bash
docker run --rm -it geographica/gdal2:2.2.1
```

Using a data volume
```bash
$ export DATAFOLDER="-v /folder_with_your_testdata/:/home/datafolder"
$ docker run $DATAFOLDER --name gdal2 -it --rm geographica/gdal2:2.2.1 /bin/bash
```
...
$ cd docker_gdal2
$ docker build -t geographica/gdal2:2.2.1 .
```
